...
<tileset version="1.10" tiledversion="1.11.2" name="Slime_morado" tilewidth="128" tileheight="128" tilecount="6" columns="6">
 <image source="Slime_morado.png" width="768" height="128"/>
 <tile id="0">
  <animation>

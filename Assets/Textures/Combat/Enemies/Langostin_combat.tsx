...
<tileset version="1.10" tiledversion="1.11.2" name="Langostin_combat" tilewidth="148" tileheight="148" tilecount="6" columns="6">
 <image source="Langostin.png" width="888" height="148"/>
 <tile id="0">
  <animation>

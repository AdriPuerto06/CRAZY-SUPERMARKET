...
<tileset version="1.10" tiledversion="1.11.2" name="Boss_death" tilewidth="128" tileheight="256" tilecount="6" columns="6">
 <image source="Boss_death.png" width="768" height="256"/>
 <tile id="0">
  <animation>

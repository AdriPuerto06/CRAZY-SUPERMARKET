...
<tileset version="1.10" tiledversion="1.11.2" name="Granny death" tilewidth="40" tileheight="40" tilecount="7" columns="7">
 <image source="Granny death.png" width="280" height="40"/>
 <tile id="0">
  <animation>

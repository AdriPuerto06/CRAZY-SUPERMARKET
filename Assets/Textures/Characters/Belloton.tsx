...
<tileset version="1.10" tiledversion="1.11.2" name="Belloton" tilewidth="43" tileheight="60" tilecount="16" columns="4">
 <image source="Belloton.png" width="172" height="240"/>
 <tile id="0">
  <animation>
